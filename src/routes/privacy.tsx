  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-20 animate-fade-in-up">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <p>
          At InsightLens AI, we prioritize your data privacy. This Privacy Policy details how we handle the images and inputs you submit to our service.
        </p>

        <h2 className="text-xl font-bold text-foreground mt-8">1. Uploaded Content</h2>
        <p>
          Any screenshot or image you upload to InsightLens AI is sent to our servers for processing via secure, encrypted channels (HTTPS). The images are sent to Gemini Vision APIs to analyze their contents and are deleted shortly after processing.
        </p>
