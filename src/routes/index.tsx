  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 pb-24">
        {/* Hero */}
        <section className="relative pt-16 pb-20 text-center lg:pt-24 lg:pb-28 overflow-hidden">
          ...
          <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            Upload a screenshot of any UI, code snippet, or complex dashboard. InsightLens AI instantly extracts text, analyzes visual hierarchy, and provides actionable insights.
          </p>
